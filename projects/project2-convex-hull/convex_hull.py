...
# to be displayed.
    ...
    def combine(self,l_points,r_points):
        ...
        #points = self.add_top_left_side(l_points[0],top_l,l_points)
...
# the finding of the hull
    def compute_hull( self, points, pause, view):
        ...
        #points = [QPointF(-0.06497354041572767, 0.020731865290767093),QPointF(0.2589470988470015, 0.49210390954117633), QPointF(0.7802170655842446, -0.27517740152568715), QPointF(-0.12090869034040619, -0.4024538576552268), QPointF(-0.7576767678606016, 0.4148990056214117)]
